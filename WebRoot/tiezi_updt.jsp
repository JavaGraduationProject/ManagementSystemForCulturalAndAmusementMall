...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateTiezi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改帖子<input type="hidden" name="id" value="${tiezi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bankuai.value='${tiezi.bankuai}';</script>	<script language="javascript">document.form1.biaoti.value='${tiezi.biaoti}';</script>	<script language="javascript">document.form1.leixing.value='${tiezi.leixing}';</script>	<script language="javascript">document.form1.neirong.value='${tiezi.neirong}';</script>	<script language="javascript">document.form1.fujian.value='${tiezi.fujian}';</script>	<script language="javascript">document.form1.faburen.value='${tiezi.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
