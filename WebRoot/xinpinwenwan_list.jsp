				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">新品文玩列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xinpinwenwanList.do" name="myform" method="post">
									...
									<input type="submit" value="查询" class="btn btn-info btn-small" /> <input type="button" value="导出excel" onClick="javascript:location.href='xinpinwenwan_listxls.jsp';" class="btn btn-info btn-small" />
								</form>								</td>
						</tr></table>
					  </td>
			    </tr>
				...
				%>
                            <tr align="center">
                             ...
                             <td>${u.wenwanbianhao}</td>    <td>${u.wenwanmingcheng}</td>    <td>${u.wenwanleibie}</td>    <td width='90' align='center' bgcolor='#ebf0f7'><a href='${u.wenwantupian}' target='_blank'><img src='${u.wenwantupian}' width=88 height=99 border=0 /></a></td>    <td>${u.kucun}</td>    <td>${u.wenwanjiage}</td>        
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateXinpinwenwan.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteXinpinwenwan.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="xpwwDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
...
while(RS_result.next()){
		 ...
		 <c:if test="${page.page>1}">
              <a href="xinpinwenwanList.do?page=1" >首页</a>
             <a href="xinpinwenwanList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xinpinwenwanList.do?page=${page.page+1 }">下一页</a>
			<a href="xinpinwenwanList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
