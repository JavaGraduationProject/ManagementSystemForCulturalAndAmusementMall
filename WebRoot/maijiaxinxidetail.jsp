...
<jsp:include page="bht.jsp"></jsp:include>
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>买家账号：</td><td width='39%'>${maijiaxinxi.maijiazhanghao}</td><td  rowspan=5 align=center><a href=${maijiaxinxi.touxiang} target=_blank><img src=${maijiaxinxi.touxiang}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>密码：</td><td width='39%'>******</td></tr><tr>                  <td width='11%' height=44>买家姓名：</td><td width='39%'>${maijiaxinxi.maijiaxingming}</td></tr><tr>         <td width='11%' height=44>性别：</td><td width='39%'>${maijiaxinxi.xingbie}</td></tr><tr>         <td width='11%' height=44>买家电话：</td><td width='39%'>${maijiaxinxi.maijiadianhua}</td></tr><tr>                  <td width='11%' height=100  >收货地址：</td><td width='39%' colspan=2 height=100 >${maijiaxinxi.shouhuodizhi}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("maijiaxinxi",id)){
	pli=pli+1;
     %>
                                   <tr>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回  class='hsgqiehuanshitu' onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 class='hsgqiehuanshitu' onClick="javascript:window.print()" /> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 class='hsgqiehuanshitu' onClick="javascript:hsgpinglun('maijiaxinxi','<%=id%>')"/><input type=button name=Submit52 value=收藏 class='hsgqiehuanshitu' onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biaoj=mjxx&biao=maijiaxinxi&ziduan=maijiazhanghao';" /></td></tr>
