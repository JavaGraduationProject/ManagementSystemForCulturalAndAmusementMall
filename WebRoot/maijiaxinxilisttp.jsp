...
<form action="mjxxListtp.do" name="myform" method="post" style="width:100%">
									...
									<input type="submit" value="查询" class='hsgqiehuanshitu' /> <input type="button" name="Submit2" value="切换视图" class='hsgqiehuanshitu'  onClick="javascript:location.href='mjxxList.do';" />
								</form>	
<br />
...
<table width="100%" height="12%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				%>
                           <td height="316" align="center"><table height="285" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="250" align="center"><a href="mjxxDetail.do?id=${u.id}"><img src="${u.touxiang}" width="210" height="250" border="0" style="border-radius: 18px;" /></a></td>
                                </tr>
                                <tr>
                                  <td height="26" align="center">${u.maijiaxingming}</td>
                                </tr>
                            </table></td>
							  <%
								if (i==4)
...
<p align="center"> <c:if test="${sessionScope.p==1}">
		 <c:if test="${page.page>1}">
              <a href="mjxxListtp.do?page=1" >首页</a>
             <a href="mjxxListtp.do?page=${page.page-1}"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="mjxxListtp.do?page=${page.page+1}">下一页</a>
			<a href="mjxxListtp.do?page=${page.totalPage}">末页</a>		    </c:if>		
	</c:if>
	</p>
