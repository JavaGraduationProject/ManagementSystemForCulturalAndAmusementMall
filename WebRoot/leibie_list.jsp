...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">类别列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="leibieList.do" name="myform" method="post">
									查询   文玩类别：<input name="wenwanleibie" type="text" id="wenwanleibie" class="form-control2" />
									<input type="submit" value="查询" class="btn btn-info btn-small" /> <input type="button" value="导出excel" onClick="javascript:location.href='leibie_listxls.jsp';" class="btn btn-info btn-small" />
								</form>								</td>
						</tr></table>
					  </td>
			    </tr>
				...
				%>
                            <tr align="center">
                             ...
                             <td>${u.wenwanleibie}</td>    
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateLeibie.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteLeibie.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="leibieList.do?page=1" >首页</a>
             <a href="leibieList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="leibieList.do?page=${page.page+1 }">下一页</a>
			<a href="leibieList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
