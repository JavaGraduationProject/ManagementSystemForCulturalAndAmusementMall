...
<jsp:include page="bht.jsp"></jsp:include>
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>文玩编号：</td><td width='39%'>${cuxiaowenwan.wenwanbianhao}</td><td  rowspan=7 align=center><a href=${cuxiaowenwan.wenwantupian} target=_blank><img src=${cuxiaowenwan.wenwantupian}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>文玩名称：</td><td width='39%'>${cuxiaowenwan.wenwanmingcheng}</td></tr><tr>         <td width='11%' height=44>文玩类别：</td><td width='39%'>${cuxiaowenwan.wenwanleibie}</td></tr><tr>                  <td width='11%' height=44>库存：</td><td width='39%'>${cuxiaowenwan.kucun}</td></tr><tr>         <td width='11%' height=44>原价格：</td><td width='39%'>${cuxiaowenwan.yuanjiage}</td></tr><tr>         <td width='11%' height=44>促销折扣：</td><td width='39%'>${cuxiaowenwan.cuxiaozhekou}</td></tr><tr>         <td width='11%' height=44>促销价格：</td><td width='39%'>${cuxiaowenwan.cuxiaojiage}</td></tr><tr>                  <td width='11%' height=100  >文玩简介：</td><td width='39%' colspan=2 height=100 >${cuxiaowenwan.wenwanjianjie}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("cuxiaowenwan",id)){
	pli=pli+1;
     %>
                                   <tr>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回  class='hsgqiehuanshitu' onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 class='hsgqiehuanshitu' onClick="javascript:window.print()" /> <input type=button name=Submit53 class='hsgqiehuanshitu' value=加入购物车 onClick="javascript:location.href='cuxiaogouwucheadd.jsp?id=<%=request.getParameter("id")%>';"  /> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 class='hsgqiehuanshitu' onClick="javascript:hsgpinglun('cuxiaowenwan','<%=id%>')"/><input type=button name=Submit52 value=收藏 class='hsgqiehuanshitu' onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biaoj=cxww&biao=cuxiaowenwan&ziduan=wenwanbianhao';" /></td></tr>
