...
<link rel="stylesheet" href="images/hsgcommon/common.css" type="text/css">
	...
	<body>
			<form action="updateMaijiaxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改买家信息<input type="hidden" name="id" value="${maijiaxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.maijiazhanghao.value='${maijiaxinxi.maijiazhanghao}';</script>	<script language="javascript">document.form1.mima.value='${maijiaxinxi.mima}';</script>	<script language="javascript">document.form1.touxiang.value='${maijiaxinxi.touxiang}';</script>	<script language="javascript">document.form1.maijiaxingming.value='${maijiaxinxi.maijiaxingming}';</script>	<script language="javascript">document.form1.xingbie.value='${maijiaxinxi.xingbie}';</script>	<script language="javascript">document.form1.maijiadianhua.value='${maijiaxinxi.maijiadianhua}';</script>	<script language="javascript">document.form1.shouhuodizhi.value='${maijiaxinxi.shouhuodizhi}';</script>	
					 </table>
			</form>
   </body>
</html>
